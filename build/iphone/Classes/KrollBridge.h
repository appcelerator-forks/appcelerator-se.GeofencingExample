...
@interface GeofencingClassicObject : KrollCoverageObject {
#else
@interface GeofencingClassicObject : KrollObject {
#endif
@private
...
extern NSString * GeofencingClassic$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	GeofencingClassicObject *_geofencingclassic;
    KrollObject* console;
	BOOL shutdown;
