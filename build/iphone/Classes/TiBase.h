...
// in simulator we redefine to format for GeofencingClassic Developer console
...
{\
	NSString * exceptionName = [@"org.geofencingclassic." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.geofencingclassic";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIGeofencingClassicNativeItemNone = -1, 
	UIGeofencingClassicNativeItemSpinner = -2,
	UIGeofencingClassicNativeItemProgressBar = -3,
	
	UIGeofencingClassicNativeItemSlider = -4,
	UIGeofencingClassicNativeItemSwitch = -5,
	UIGeofencingClassicNativeItemMultiButton = -6,
	UIGeofencingClassicNativeItemSegmented = -7,
	
	UIGeofencingClassicNativeItemTextView = -8,
	UIGeofencingClassicNativeItemTextField = -9,
	UIGeofencingClassicNativeItemSearchBar = -10,
	
	UIGeofencingClassicNativeItemPicker = -11,
	UIGeofencingClassicNativeItemDatePicker = -12,
	
	UIGeofencingClassicNativeItemInfoLight = -13,
	UIGeofencingClassicNativeItemInfoDark = -14,
	
	UIGeofencingClassicNativeItemDisclosure = -15,
	
	UIGeofencingClassicNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all GeofencingClassic instances of
