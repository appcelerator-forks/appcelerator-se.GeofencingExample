...
/**
 Base class for all GeofencingClassic views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the GeofencingClassic view hierarchy (such as wrapped iOS UIViews) was touched.
