...
//@interface GeofencingClassicObject : NSObject
//@end

@interface GeofencingClassicObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[GeofencingClassicObject class]])
		{
			for (NSString *key in [[(GeofencingClassicObject*)o modules] allKeys])
			{
