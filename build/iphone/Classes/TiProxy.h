...
//Rare exceptions to indicate a bug in the _geofencingclassic code (Eg, function that a subclass should have implemented)
...
/**
 The base class for GeofencingClassic proxies.
 */
