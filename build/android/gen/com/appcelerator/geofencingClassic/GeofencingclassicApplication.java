...
public final class GeofencingclassicApplication extends TiApplication
{
	private static final String TAG = "GeofencingclassicApplication";
	...
	public void onCreate()
	{
		...
		appInfo = new GeofencingclassicAppInfo(this);
		postAppInfo();
		...
		runtime.addExternalModule("ti.geofence", ti.geofence.GeofenceBootstrap.class);
		...
		moduleInfo = new KrollModuleInfo(
			"geofence", "ti.geofence", "ea61d3a7-754a-4fb0-9ed0-e96e59a0e76e", "1.0.0",
			"Monitoring geo regions", "Jon Alter", "Appcelerator Commercial License",
